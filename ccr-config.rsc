# jun/24/2025 00:26:15 by RouterOS 6.49.18
...
/ip dhcp-server
add address-pool=mgmt-pool disabled=no interface=vlan10-mgmt name=dhcp-mgmt
...
add bridge=br-lan comment="trunk port" interface=sfp-sfpplus11
/ip address
...
add address=10.10.10.1/24 comment="gateway for mgmt" interface=vlan10-mgmt network=10.10.10.0
